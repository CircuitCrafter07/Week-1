...
Welcome to Day 1** of the RISK-V tapeout Workshop!  
Today, we begin our journey into digital design by learning Verilog, an open-source simulation tool with **Icarus Verilog (iverilog)**, and the basics of logic synthesis using **Yosys**. This will walk you through practical labworks, essential concepts, and insightful explanations to help you understand and build  a strong foundation in RTL design.
